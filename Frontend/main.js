let url = "https://live-posts.herokuapp.com"
...
function createPosts(){
    ...
    for (let i=0; i<currentData.length; i++){
        ...
        title.innerHTML = currentData[i].title
        secondDiv.appendChild(title)

        let desc = document.createElement("p")
        desc.setAttribute("class", "text-justify")
        desc.innerHTML = currentData[i].description
        ...
        date.innerHTML = new Date(currentData[i].addedDate)
        ...
        comment.setAttribute("class", "btn btn-primary")
